...
// This structure maps Podman/Docker-compatible image metadata to a common format.
...
type ContainerInfo struct {
	...
	Image string `json:"Image"`
	// State is the current lifecycle state reported by Podman
