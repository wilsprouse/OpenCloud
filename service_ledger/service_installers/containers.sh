...
# service. It delegates to container_registry.sh to set up containerd and
# buildkit, which are the container runtime components needed to pull and run
# containers.
#
# Requirements:
#   - Ubuntu/Debian-based system
#   - sudo privileges
#   - See container_registry.sh for full requirements
################################################################################
